...
{
    public ArrowsHandleButton Up;
    public ArrowsHandleButton Down;
    public ArrowsHandleButton Left;
    public ArrowsHandleButton Right;

    public ArrowsHandleButton LeftUp;
    public ArrowsHandleButton LeftDown;
    public ArrowsHandleButton RightUp;
    public ArrowsHandleButton RightDown;

    public float startOffsetVertical;
    public float midOffsetVertical;
    public float midSizeVertical;
    public float endOffsetVertical;
    public float endSizeVertical;

    public float startOffsetHorizontal;
    public float midOffsetHorizontal;
    public float midSizeHorizontal;
    public float endOffsetHorizontal;
    public float endSizeHorizontal;
